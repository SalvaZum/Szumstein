...
const proyectos=[
    ...
    año:"2024",
    descripcion:"En esta competencia organizada por la UCC, forme parte de un equipo aleatorio con el cual tuvimos que solucionar un problema real de una de las empresas asociadas al evento. Nuestro desafio fue crear una solucion para la empresa Akron, y gracias a nuestra innovaciòn ganamos a los demas equipos que formaban parte de la misma empresa, para quedar top 3 de la competencia."
    },
    {
    ...
    año:"2024",
    descripcion:"Durante unos meses me dedique a crear un videojuego en Gdevelop donde yo mismo hice todo el trabajo que el mismo involucra como: planifique el videojuego, programe, hice los sprites y animaciones, añadi los sonidos y efectos especiales del videojuego, etc."
    },
    {
    ...
    año:"2023-2024",
    descripcion:"Durante dos años continuos me dedique a subir contenido semanalmente sobre videojuegos, logrando monetizarlo. Todo el procedimiento de creaciòn de los videos, desde: crear la idea, redactar un guion, grabar el material visual, buscar material sonoro e imagenes, editar el video, crear la miniatura, y promocionarlo, fue producciòn propia."
    },
    {
    ...
    categoria: "ajedrez",
    año:"2024 y 2025",
    descripcion:"En la ONIET, olimpiada organizada por la Universidad Blas Pascal, participe ambos años de la competencia de ajedrez presencial donde en 2024 gane el primer puesto, luego en 2025, sin ninguna preparaciòn previa, logre obtener el tercer lugar"
    },
]
...
formacionLaboral.forEach(pagina => {
    ...
    div.innerHTML = `
        ...
        <div style="display:flex; flex-direction: row; justify-content: center; gap: 10px; flex-wrap: wrap;">
            ...
            <p style="padding: 5px 10px; border-radius: 15px; font-size: 14px; margin: 5px;">${pagina.año}</p>
        </div>
...
proyectos.forEach(pagina => {
    ...
    <div class="content" style="display: none; padding: 0 15px;">
        ...
        <div style="display:flex; flex-direction: row; justify-content: center; gap: 10px; flex-wrap: wrap; margin: 15px 0;">
            ...
            <p style="padding: 5px 10px; border-radius: 15px; font-size: 14px; background: #306fc2ff; margin: 0;">${pagina.año}</p>
        </div>
